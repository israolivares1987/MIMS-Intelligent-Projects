...
<head>
    ...
    <META HTTP-EQUIV="REFRESH" CONTENT="5;URL=<?php echo base_url('index.php/Login');?>">
...
<!-- Page script -->
    ...
    <script  src="<?php echo base_url('assets/script/jquery.validate.min.js')?>"></script>
                ...
                <div class="h-100 no-gutters row">
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h4 class="mb-0">
<span class="d-block">Exito,</span>
<span><?php echo $MensajeError;?></span></h4>
                            <div class="divider row"></div>
                            <div>
                                    <div class="d-flex">
                                        <div class="ml-auto">
                                            <button class="btn btn-primary btn-lg" id="btn_login">Iniciar Sesion</button>
                                        </div>
                                    </div>
