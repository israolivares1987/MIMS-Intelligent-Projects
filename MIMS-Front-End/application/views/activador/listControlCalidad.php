   ...
   <div class="content-wrapper">
       ...
       <section class="content-header">
           <div class="container-fluid">
               <div class="row mb-2">
                   <div class="col-sm-6">
                       <h1>Control de calidad orden de compra</h1>
                   </div>
               </div>
           </div><!-- /.container-fluid -->
       </section>
           ...
           <div class="row">
               <div class="col-12">
                   <div class="card">
                       ...
                       <div class="card-body">
                           <br />
                           <button class="btn btn-block btn-outline-success" onclick="add_ControlCalidad()"><i
                                   class="glyphicon glyphicon-plus"></i> Agregar Registro Control de Calidad</button>
                           ...
                           <br />
                           <br />
                           <table id="ListControlCalidad" class="table table-striped table-bordered" cellspacing="1"
                               width="99%">
                               <thead>
                                   <tr>
                                       <th>Acciones</th>
               ...
               function reload_table() {
                   $('#ListControlCalidad').DataTable().ajax.reload();
               }

               function add_ControlCalidad() {
                   save_method = 'add';
                   $('#form')[0].reset(); // reset form on modals
                   $('.form-group').removeClass('has-error'); // clear error class
                   $('.help-block').empty(); // clear error string
                   $('#modal-default').modal('show'); // show bootstrap modal
                   $('.modal-title').text('Agregar registro control de calidad'); // Set Title to Bootstrap modal title
               }

               function edit_ControlCalidad(id) {
                   save_method = 'update';
                   $('#form')[0].reset(); // reset form on modals
                   $('.form-group').removeClass('has-error'); // clear error class
                   $('.help-block').empty(); // clear error string
               ...
               function delete_ControlCalidad(id) {
                   ...
                   <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                           <div class="modal-header">
                               <h4 class="modal-title">Agregar registro control de calidad en orden</h4>
