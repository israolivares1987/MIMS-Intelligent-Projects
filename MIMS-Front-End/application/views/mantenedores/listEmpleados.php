            ...
            function recargaEmpleados() {
                 ...
                 $.ajax({
                     ...
                     $.each(result.empleados, function(key, empleado) {
                        ...
                        empleados_html += '<td>';
                        empleados_html += '<button data-toggle="tooltip" data-placement="left" title="Editar Empleado" onclick="edit_empleado('+empleado.ID+')" class="btn btn-outline-info btn-sm mr-1"><i class="fas fa-edit"></i></button>';
                        empleados_html += '<button data-toggle="tooltip" data-placement="left" title="Eliminar Empleado" onclick="elimina_empleado('+empleado.ID +')" class="btn btn-outline-danger btn-sm"><i class="far fa-trash-alt"></i></button>';
                        empleados_html += '</td>';
                        empleados_html += '</tr>';
