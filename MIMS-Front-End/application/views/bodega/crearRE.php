         ...
         <div class="row">
             <div class="col-12">
                     <div class="card-body">
                        ...
                        <input type="button" class="btn btn-warning" name="vender" value="Crear RE" id="vender">
                         <table id="tbl_rr" class="table table-striped table-bordered" cellspacing="0" width="100%">
                             ...
                             <th><i class="fa fa-check"></i>&nbsp;Selección articulo</th>
                                         ...
                                         <th class="grey" >Cantidad Disponible en Bodega</th>
                                         <th class="grey" >Cantidad Entregada</th>
                                         <th>Estado</th>
                                         <th>O.C Proveedor</th>
                                         <th>ID MIMS</th>
                                         </tr>
             ...
             function recargaBuckSheet(orden, cliente) {
                 ...
                 $.ajax({
                     ...
                     $.each(result.bucksheets, function(key, bucksheets) {
                        ...
                        bucksheet_html += '<td class="grey" >1</td>';
                        bucksheet_html += '<td class="grey" >10</td>';
