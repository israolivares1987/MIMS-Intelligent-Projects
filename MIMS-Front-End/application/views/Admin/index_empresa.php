            ...
            function recargaEmpleados() {
                 ...
                 $.ajax({
                     ...
                     $.each(result.empresas, function(key, empresaTO) {
                        ...
                        empleados_html += '<td>';
                        empleados_html += '<button data-toggle="tooltip" data-placement="top" title="Editar Empleado" onclick="edit_empresa('+empresaTO.cod_empresa+')" class="btn btn-outline-info btn-sm mr-1"><i class="fas fa-edit"></i></button>';
                        empleados_html += '<button data-toggle="tooltip" data-placement="top" title="Eliminar Empleado" onclick="elimina_empresa('+empresaTO.cod_empresa +')" class="btn btn-outline-danger btn-sm"><i class="far fa-trash-alt"></i></button>';
                        empleados_html += '</td>';
                        empleados_html += '</tr>';
